...
-- And operator
-- SELECT * from students where gender='M' and city='Chandigarh';

-- OR operator
-- ';SELECT * from students where gender='M' or city='Chandigarh

-- not operator
SELECT * from students where not city='Chandigarh';
